...
<?php 
    ...
    if(isset($_POST["submitlogin"]))
    {
        ...
        $passuser = $_POST["pass"];
        $sql_login = mysqli_query($connection, "select * from admin where adminUsername = '$emailuser' and adminPassword = '$passuser'");
        ...
        if(mysqli_num_rows($sql_login)>0)
        {
            ...
            $_SESSION['emailuser'] = $row_admin['adminUsername'];
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="POST" class="user">
                                        <div class="form-group">
                                            <input type="username" name="useremail" class="form-control form-control-user"
