...
<?php 
    ...
    if(isset($_POST['Simpan']))
    {
        ...
        $provinsiID = $_POST['inputkode'];
       
        
        
        mysqli_query($connection, "insert into kabupaten values ('$kabupatenID', '$kabupatenNama', '$provinsiID')");
...
<div class="col-sm-1">
    ...
    <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4">Input Form Untuk Kabupaten</h1>
  ...
  <div class="form-group row">
    <label for="kecamatanid" class="col-sm-2 col-form-label">Kode Kabupaten</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="kecamatanid" name="inputid" placeholder="Kode Kabupaten" maxlength="4">
    </div>
  </div>

  <div class="form-group row">
    <label for="kecamatannama" class="col-sm-2 col-form-label">Nama Kabupaten</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputnama" id="kecamatannama" placeholder="Nama Kabupaten">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <select id="provinsiID" class="form-control" name="inputkode">
