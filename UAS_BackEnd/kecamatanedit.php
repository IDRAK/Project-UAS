...
<?php 
    ...
    if(isset($_POST['ubah']))
    {
        ...
        mysqli_query($connection, "UPDATE kecamatan set kecamatanID='$kodekec',kecamatanNama='$namakec',kabupatenID= '$kabupatenID'
    ...
    $kodekec = $_GET["ubafoto"];
    $editkec = mysqli_query($connection,"SELECT * from kecamatan
    where kecamatanID = '$kodekec'");
    
    $rowedit = mysqli_fetch_array($editkec);

    // $editkab = mysqli_query($connection,"SELECT * from kecamatan, kabupaten
    // where kecamatanID = '$kodekec' AND kecamatan.kabupatenID = kabupaten.kabupatenID");
    
    // $rowedit2 = mysqli_fetch_array($editkab);
...
<div class="col-sm-10">
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Edit Form Kecamatan</h1>
        </div>
    </div>
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="kodekecamatan" name="inputkode" value="<?php echo $rowedit["kecamatanID"]?>" readonly>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="kabupatenID" class="col-sm-2 col-form-label">Alamat Kecamatan</label>
            <div class="col-sm-10">
...
<div class="row">
    ...
    <div class="col-sm-10">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4">Daftar hasil Edit Kecamatan</h1>
            </div>
        </div>
    ...
    <table class="table table-hover table-danger">
        ...
        <tbody>
        <?php $query = mysqli_query($connection, "select * from kecamatan");
            $nomor = 1;
